...
:globe_with_meridians: [KO](/비인증결제/example/payco-request-billing-key.md)

You can request for a billing key through the Payco simple payment window and then request subsequent payments with the billing key.<Br />
