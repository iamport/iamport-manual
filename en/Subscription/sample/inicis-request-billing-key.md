...
:globe_with_meridians: [KO](/비인증결제/example/inicis-request-billing-key.md)

You can request for a billing key through the KG INICIS payment window and then request subsequent payments with the billing key.<Br />
